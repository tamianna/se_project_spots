...
import { setButtonText, handleSubmitButton } from "../utils/helpers.js";
...
const closeDeleleModal = deleteCardModal.querySelector(
...
handleSubmitButton(() => {
  return api.editAvatarImage(avatarLink.value)
    .then((data) => {
